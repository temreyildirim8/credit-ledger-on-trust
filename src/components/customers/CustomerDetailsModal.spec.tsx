...
//       await import("@/lib/services/customers.service");
//     const { userProfilesService } =
//       await import("@/lib/services/user-profiles.service");
...
//       const { generateCustomerStatementPDF, downloadPDF } =
//         await import("@/lib/utils/pdf-statement");
//       vi.mocked(generateCustomerStatementPDF).mockResolvedValue(
//         new Uint8Array(),
//       );
...
//       const { generateCustomerStatementPDF } =
//         await import("@/lib/utils/pdf-statement");
//       vi.mocked(generateCustomerStatementPDF).mockRejectedValue(
//         new Error("PDF error"),
//       );
...
//         const waLink = whatsappLinks.find((link) =>
...
//       await waitFor(() => {
//         expect(customersService.getCustomerById).toHaveBeenCalledWith(
//           "user-1",
//           "customer-1",
//         );
//       });
...
//       await waitFor(() => {
//         expect(customersService.getCustomerTransactions).toHaveBeenCalledWith(
//           "user-1",
//           "customer-1",
//         );
//       });
...
//       const { customersService } =
//         await import("@/lib/services/customers.service");
//       vi.mocked(customersService.getCustomerById).mockRejectedValue(
...
//         expect(
//           screen.queryByText("Purchase on credit"),
...
//       rerender(
//         <CustomerDetailsModal {...defaultProps} customerId="customer-2" />,
//       );
...
//         <CustomerDetailsModal {...defaultProps} open={false} />,
//       );
