      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-8 relative shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]"
            >
              <Quote className="h-10 w-10 text-[#3c83f6]/20 absolute top-6 right-6" />
              ...
              <p className="text-[#0f172a] mb-6 leading-relaxed relative text-[16px]">
